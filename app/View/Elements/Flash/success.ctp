<div class="alert alert-stock-flash alert-stock-success d-flex align-items-center justify-content-between fade show" role="alert">
    <div class="d-flex align-items-center gap-2">
        ...
        <span><?php echo h(isset($message) ? $message : ''); ?></span>
    </div>
